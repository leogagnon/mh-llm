from .outputs import ModelRunnerOutput, EngineCoreOutput
...
class Scheduler(BaseScheduler):
  ...
  def update_from_output(
    ...
    power_logprobs = model_runner_output.power_logprobs
    ...
    for req_id, num_tokens_scheduled in num_scheduled_tokens.items():
      ...
      if request.sampling_params is not None \
        ...
        new_power_logprobs = power_logprobs.slice(
            req_index,
            req_index + 1,
        ) if power_logprobs else None
